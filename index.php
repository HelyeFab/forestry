...
<head>
    ...
    <meta property="og: title" content="Beano Web Design - Responsive and stunning web sites">
    <meta property="og: url" content="https://beanowebdesign.com/">
    <meta property="og:site_name" content="BeanoWebDesign">
    <meta property="og: description"
        content="Web designer based in Edinburgh, Scotland. We create beautiful websites which are mobile friendly and look good on all screens and devices. Passionate about UI and UX we  want users to enjoy their navigation while browsing my websites.">
...
.logo__containter svg {
  height: 6rem;
  width: 6rem;
}

.logo__containter svg .customColor {
  fill: white;
  stroke: white;
}
...
.hero::after {
  ...
  bottom: 0;
  width: 100%;
  background-image: url(/css/svg/wave.svg);background-size:cover;background-repeat:no-repeat;background-position:center;height:15%}.hero__content{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.hero__content-title{font-size:4rem;color:white;text-align:center;letter-spacing:1rem;margin-bottom:2rem}@media (max-width:62em){.hero__content-title{font-size:2.8rem;margin-top:-10rem}}.hero__content-main{font-size:2.4rem;font-weight:200;color:white;max-width:70%;text-align:center;margin-bottom:2rem}@media (max-width:62em){#heroCta{margin-top:10rem}}</style>
    
    <link rel="stylesheet" href="css/main.css">
    <title>Web Design Edinburgh | Beano Web Design </title>
</head>
...
<body>
    ...
    <header>
        <nav class="navbar">
            <div class="logo">
                <a href="#home">
                    <div class="logo__containter">
                        <svg class="customColor" width="157" height="300" viewBox="0 0 157 300" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="1.5" y="1.5" width="154" height="297" stroke="white" stroke-width="3" />
                            <path class="customColor"
                                d="M90.864 48.768C93.4667 49.4933 95.5147 50.816 97.008 52.736C98.5013 54.6133 99.248 57.0027 99.248 59.904C99.248 63.7867 97.776 66.7733 94.832 68.864C91.9307 70.9547 87.6853 72 82.096 72H60.72V27.2H80.816C85.936 27.2 89.8827 28.224 92.656 30.272C95.472 32.32 96.88 35.1573 96.88 38.784C96.88 41.1307 96.3253 43.1573 95.216 44.864C94.1493 46.5707 92.6987 47.872 90.864 48.768ZM67.12 32.384V46.72H80.24C83.5253 46.72 86.0427 46.1227 87.792 44.928C89.584 43.6907 90.48 41.8987 90.48 39.552C90.48 37.2053 89.584 35.4347 87.792 34.24C86.0427 33.0027 83.5253 32.384 80.24 32.384H67.12ZM81.84 66.816C85.4667 66.816 88.1973 66.2187 90.032 65.024C91.8667 63.8293 92.784 61.952 92.784 59.392C92.784 54.4 89.136 51.904 81.84 51.904H67.12V66.816H81.84Z"
                                fill="#0D703A" />
                            <path class="customColor"
                                d="M110.016 129.2L95.04 174H88.32L76.096 138.224L63.872 174H57.024L42.048 129.2H48.64L60.736 165.616L73.344 129.2H79.232L91.584 165.808L103.936 129.2H110.016Z"
                                fill="#0D703A" />
                            <path class="customColor"
                                d="M56.72 229.2H75.6C80.336 229.2 84.5387 230.139 88.208 232.016C91.8773 233.893 94.7147 236.539 96.72 239.952C98.768 243.323 99.792 247.205 99.792 251.6C99.792 255.995 98.768 259.899 96.72 263.312C94.7147 266.683 91.8773 269.307 88.208 271.184C84.5387 273.061 80.336 274 75.6 274H56.72V229.2ZM75.216 268.432C78.8427 268.432 82.0213 267.728 84.752 266.32C87.5253 264.912 89.6587 262.949 91.152 260.432C92.6453 257.872 93.392 254.928 93.392 251.6C93.392 248.272 92.6453 245.349 91.152 242.832C89.6587 240.272 87.5253 238.288 84.752 236.88C82.0213 235.472 78.8427 234.768 75.216 234.768H63.12V268.432H75.216Z"
                                fill="#0D703A" />
                            <line class="customColor" x1="26" y1="200.5" x2="131" y2="200.5" stroke="#0D703A"
                                stroke-width="3" />
                            <line class="customColor" x1="26" y1="103.5" x2="131" y2="103.5" stroke="#0D703A"
                                stroke-width="3" />
                        </svg>
                    </div>
                </a>
            ...
            <ul class="navbar__menu">
                <li class="navbar__menu-item"><a class="navigation__link" href="#home">Home</a></li>
                <li class="navbar__menu-item"><a class="navigation__link" href="#about">About</a></li>
                <li class="navbar__menu-item"><a class="navigation__link" href="#services">Services</a></li>
                <li class="navbar__menu-item"><a class="navigation__link" href="#work">Our Work</a></li>
                <li class="navbar__menu-item"><a class="navigation__link" href="#packages">Packages</a></li>
                <li class="navbar__menu-item"><a class="navigation__link" href="#contact">Contact Us</a> </li>
            </ul>
    ...
    <section class="hero" id='home'>
        <div class="hero__content">
            <div class="hero__content-title">
                <h1>Beano Web Design</h1>
            </div>
            <div class="hero__content-main">
                <span>where your ideas become beautiful designs
                </span>
            </div>
            <div class="cta" id='heroCta'>
                <a class="btn expand ourWorkBtn" href="#contact">We are here to help</a>
            </div>
        </div>
        <div class="returnHome">
            <a href="#home"> <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home"
    ...
    <section class="about" id='about'>
        <div class="wrapper">
            <div class="wrapper__visual">
                <div class="wrapper__visual-svg">
                    <svg id="fc836297-f37e-43a2-86b4-5406f4a63596" data-name="Layer 1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width=""
                        height="" viewBox="0 0 1130.08 738.14">
                        <defs>
                            <linearGradient id="a340ed46-1652-4aba-8925-cf57be9109ca" x1="421.41" y1="548.67"
                                x2="423.73" y2="548.67" gradientUnits="userSpaceOnUse">
                        ...
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#1c92d2" opacity="0.1" />
                        <rect x="360" y="359.24" width="283.43" height="65.63" fill="#565661" />
                        <rect x="360" y="359.24" width="283.43" height="65.63" opacity="0.1" />
                        <polygon points="393.91 427.03 395.9 602.24 368.64 671.06 366.53 427.03 393.91 427.03"
                            fill="#bcbec9" />
                        <polygon points="362.99 371.84 638.94 373.5 638.94 422.38 362.99 422.38 362.99 371.84"
                            fill="#565661" />
                        <polygon points="615.33 427.03 638.94 430.36 638.94 668.4 615.33 595.59 615.33 427.03"
                            fill="#bcbec9" />
                        <rect x="647.91" y="361.87" width="132.99" height="282.6" fill="#efeff0" />
                        <rect x="658.55" y="369.72" width="111.71" height="217.23" fill="#565661" />
                        <rect x="658.55" y="369.72" width="111.71" height="217.23" opacity="0.1" />
                        <rect x="658.55" y="374.17" width="111.71" height="48.21" fill="#565661" />
                        <rect x="658.55" y="427.03" width="111.71" height="102.4" fill="#565661" />
                        <rect x="658.55" y="535.75" width="111.71" height="102.4" fill="#565661" />
                        <rect x="658.55" y="535.75" width="111.71" height="102.4" opacity="0.1" />
                        <ellipse cx="663.21" cy="653.67" rx="7.2" ry="9.2" fill="#565661" />
                        <ellipse cx="763.06" cy="654.11" rx="7.2" ry="9.2" fill="#565661" />
                        <polygon points="359 671.06 368.64 671.06 365.99 364.32 351.35 364.32 359 671.06"
                            fill="#efeff0" />
                        <polygon points="638.94 361.87 638.94 668.4 647.91 668.4 647.91 364.32 638.94 361.87"
                            fill="#efeff0" />
                        <polygon points="366.46 419.38 366.46 430.36 638.94 430.36 638.94 422.38 366.46 419.38"
                            fill="#efeff0" />
                        <polygon
                            points="384.93 341.26 730.37 341.26 780.57 357.88 780.57 367.52 349.69 364.2 349.69 354.39 384.93 341.26"
                            fill="#fff" />
                        <polygon points="349.69 354.39 780.57 357.88 780.57 367.52 349.69 364.2 349.69 354.39"
                            fill="#bcbec9" />
                        <path d="M423.68,549.64l-2-.3c0-.09,0-.17,0-.25-.06-.47-.13-.93-.2-1.4.82.65,1.6,1.3,2.32,1.95Z"
                            transform="translate(-34.96 -80.93)" fill="url(#a340ed46-1652-4aba-8925-cf57be9109ca)" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#a26565" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#454b69" />
                        <path
                            d="M405.08,604.69a4.63,4.63,0,0,1-1.7,5c-1.31.81-3,.7-4.3,1.58-1.61,1.13-1.84,3.37-2.12,5.31-1,6.67-4.31,12.72-7.14,18.85s-5.22,12.82-4.18,19.48c.71,4.52,2.93,9.34.85,13.41-.51,1-1.27,1.89-1.85,2.86-2.85,4.76-1.23,10.79-1.34,16.33a3.23,3.23,0,0,1-.39,1.77,4.89,4.89,0,0,1-1.58,1.22,8.38,8.38,0,0,0-3.41,6.43,24.57,24.57,0,0,0,.9,7.46,4.44,4.44,0,0,0,1.23,2.6,4.6,4.6,0,0,0,2.69.76A59.84,59.84,0,0,1,401,712.19c3.79,1.58,7.47,3.56,11.5,4.32a3,3,0,0,0,2.36-.25,3.25,3.25,0,0,0,1-1.73c1.55-5.1,3.12-10.36,2.59-15.66-.23-2.28-.84-4.51-1-6.79-.7-9,5.39-17.12,7.32-26,.87-4,.87-8.14,1.49-12.18,1.68-11.07,7.78-21,10.13-31.95a34.73,34.73,0,0,1,1.52-6c1.75-4.24,5.8-7.68,5.89-12.27a4.78,4.78,0,0,0-.76-2.86,6.48,6.48,0,0,0-3.57-2,121.87,121.87,0,0,0-16.55-3.34,31.35,31.35,0,0,0-7.78-.54,22.9,22.9,0,0,0-9.52,3.36C401.76,600.68,404.24,601.25,405.08,604.69Z"
                            transform="translate(-34.96 -80.93)" opacity="0.05" />
                        <polygon
                            points="350.55 674.47 342.02 674.47 336.44 559.83 336.05 553.31 343.3 550.76 343.79 557.69 350.55 674.47"
                            fill="#565661" />
                        <polygon points="343.79 557.69 336.44 559.83 336.05 553.31 343.3 550.76 343.79 557.69"
                            opacity="0.1" />
                        <polygon
                        ...
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#fff" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#1c92d2" />
                        <path
                        ...
                        <path d="M384.38,454.83c2.47,1.86,5.15-5.23,3.62-7C387.59,448.29,384,454.57,384.38,454.83Z"
                            transform="translate(-34.96 -80.93)" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#565661" />
                        <path
                        ...
                        <polygon
                            ...
                            fill="#565661" />
                        <polygon points="701.3 559.69 708.65 561.83 709.03 555.31 701.78 552.76 701.3 559.69"
                            opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#464353" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#fff" />
                        <ellipse cx="989.97" cy="670.07" rx="97.44" ry="15.65" fill="#1c92d2" opacity="0.1" />
                        <rect x="986.83" y="370.26" width="6.27" height="141.17" fill="#535461" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#565661" />
                        <polygon points="1032.12 517.36 1031.56 526.33 948.38 526.33 947.82 517.36 1032.12 517.36"
                            fill="#9d9cb5" />
                        <polygon points="1031.33 530.08 1030.78 539.06 949.17 539.06 948.61 530.08 1031.33 530.08"
                            fill="#9d9cb5" />
                        <polygon points="1030.54 542.8 1029.98 551.77 949.96 551.77 949.4 542.8 1030.54 542.8"
                            fill="#9d9cb5" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#1c92d2" />
                        <path d="M892.68,476.18s45.67,25.35,60.33,46.34,71.92,49.32,71.92,49.32"
                            transform="translate(-34.96 -80.93)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path
                            d="M996.77,450.88c19.88,14.37,28.16,36.87,28.16,36.87s-24-.83-43.83-15.2S953,435.68,953,435.68,976.9,436.5,996.77,450.88Z"
                            transform="translate(-34.96 -80.93)" fill="#1c92d2" />
                        <path d="M953,435.68s24.86,13.8,32.83,25.22,39.15,26.85,39.15,26.85"
                            transform="translate(-34.96 -80.93)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#1c92d2" />
                        <path d="M1108.83,453.61s-29.74,25.72-37.3,43.44-45.38,47.43-45.38,47.43"
                            transform="translate(-34.96 -80.93)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#dfe6f5" />
                        <path d="M591.48,385.59a22.23,22.23,0,0,0-12.28,14.73H538.14a22.23,22.23,0,0,0-12.28-14.73Z"
                            transform="translate(-34.96 -80.93)" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" opacity="0.1" />
                        <rect x="467.03" y="343.63" width="112.29" height="6.77" rx="3.39" fill="#dfe6f5" />
                        <path
                            d="M669,233.31a11.58,11.58,0,0,0-11.59-11.58H458.5a11.57,11.57,0,0,0-11.58,11.58V376.44H669Z"
                            transform="translate(-34.96 -80.93)" fill="#474157" />
                        <path
                            ...
                            transform="translate(-34.96 -80.93)" fill="#4c4c78" />
                        <circle cx="523" cy="146.32" r="2.67" fill="#fff" />
                        <circle cx="523" cy="306.38" r="6.59" fill="#fff" />
                        <path d="M662.94,238.48H453a5.7,5.7,0,0,1,5.7-5.7H657.24A5.7,5.7,0,0,1,662.94,238.48Z"
                            transform="translate(-34.96 -80.93)" fill="#c8cad7" />
            ...
            <div class="wrapper__content">
                <div class="wrapper__content-title">
                    <h2>Welcome <br> to <br> Beano Web Design</h2>
                </div>
                <div class="wrapper__content-para">
                    <p>We are a small yet <span>innovative
                        </span> web design team based in Edinburgh. We
                        design user-friendly and simple-to-navigate web
                        sites and web applications.
                    </p>
                </div>
                <div class="wrapper__content-para">
                    <p>Our approach is Mobile First. This translates into an
                        <span>unprecedented navigation experience
                        </span>for
                        all of your visitors: no matter which device they will use.
                    </p>
                </div>
                <div class="about__cta cta">
                    <a class="btn expand" href="#contact">We are here to help</a>
                </div>
            </div>
    ...
    <section class="services" id="services">
        <h2>Our Services</h2>
        <span></span>
        <p>Beano Web Design is a development agency specialising in HTML 5 apps and websites. Our development team
            designs, builds, and supports websites for private and public institutions around the world. We apply a
            well-tested framework that allows us to complete each project on
            time and on budget without sacrificing features or functionality.</p>
        <div class="column__wrapper">
            ...
            <div class="col col2">
                <div class="col__visual">
                    <svg id="Capa_1" enable-background="new 0 0 512 512" height="" viewBox="0 0 512 512" width=""
                        xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <g>
                                <path
                                    d="m214.102 452.627h36.173c4.143 0 7.5-3.357 7.5-7.5s-3.357-7.5-7.5-7.5h-36.173c-4.143 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5z" />
                                <path
                                    d="m203.981 75.446h56.414c4.143 0 7.5-3.357 7.5-7.5s-3.357-7.5-7.5-7.5h-56.414c-4.143 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5z" />
                                ...
                                <path
                                    d="m377.58 121.063h22.732c4.143 0 7.5-3.357 7.5-7.5s-3.357-7.5-7.5-7.5h-15.232v-23.352c0-4.143-3.357-7.5-7.5-7.5s-7.5 3.357-7.5 7.5v30.852c0 4.142 3.357 7.5 7.5 7.5z" />
                                <path
                                    d="m255.279 158.831h-46.182c-30.206 0-54.78 25.304-54.78 56.407 0 21.953 12.522 42.071 31.903 51.252 1.326.629 2.183 2.033 2.183 3.579v17.443c0 4.288 2.501 8.194 6.371 9.953 1.442.656 2.958.978 4.459.977 2.527 0 5.012-.911 7.027-2.671l26.689-23.293c.614-.537 1.381-.832 2.158-.832h20.171c30.206 0 54.781-25.305 54.781-56.408s-24.574-56.407-54.78-56.407zm0 97.815h-20.171c-4.405 0-8.676 1.609-12.022 4.531l-19.683 17.179v-8.287c0-7.312-4.224-14.037-10.761-17.135-14.17-6.712-23.325-21.509-23.325-37.696 0-22.832 17.846-41.407 39.78-41.407h46.182c21.936 0 39.781 18.575 39.781 41.407.001 22.833-17.845 41.408-39.781 41.408z" />
                                <path
                                    d="m252.53 192.952h-40.684c-4.143 0-7.5 3.357-7.5 7.5s3.357 7.5 7.5 7.5h40.684c4.143 0 7.5-3.357 7.5-7.5s-3.357-7.5-7.5-7.5z" />
                                <path
                                    d="m240.985 222.013h-29.139c-4.143 0-7.5 3.357-7.5 7.5s3.357 7.5 7.5 7.5h29.139c4.143 0 7.5-3.357 7.5-7.5s-3.357-7.5-7.5-7.5z" />
                                <path
                                    d="m498.738 242.366c-3.512-26.566-25.52-47.946-52.33-50.837-2.21-.237-4.444-.358-6.643-.358h-.002c-15.884 0-30.818 6.148-42.053 17.313-11.249 11.179-17.444 26.045-17.444 41.859 0 10.312 2.722 20.477 7.879 29.411l39.942 68.836c2.442 4.203 6.809 6.712 11.679 6.712 4.871 0 9.237-2.508 11.681-6.714l39.941-68.836c6.544-11.333 9.086-24.261 7.35-37.386zm-20.332 29.872-38.64 66.592-38.639-66.589c-3.834-6.644-5.861-14.216-5.861-21.898 0-11.79 4.623-22.878 13.017-31.219 8.406-8.354 19.586-12.953 31.482-12.953 1.664 0 3.358.092 5.036.272 20.02 2.158 36.449 18.093 39.065 37.888 1.3 9.821-.592 19.476-5.46 27.907z" />
                                <path
                                    d="m439.767 223.236c-14.055 0-25.489 11.435-25.489 25.489 0 14.056 11.435 25.49 25.489 25.49 14.056 0 25.49-11.435 25.49-25.49 0-14.054-11.435-25.489-25.49-25.489zm0 35.98c-5.784 0-10.489-4.706-10.489-10.49s4.705-10.489 10.489-10.489 10.49 4.705 10.49 10.489-4.706 10.49-10.49 10.49z" />
                                <path
                                    d="m364.103 410.58c-3.238-1.933-7.287-1.979-10.566-.116-3.28 1.861-5.317 5.36-5.317 9.132v48.748c0 3.771 2.037 7.271 5.316 9.132 1.605.91 3.395 1.365 5.183 1.365 1.865 0 3.731-.495 5.385-1.482l40.813-24.374c3.203-1.914 5.116-5.283 5.116-9.015s-1.913-7.103-5.116-9.016zm-.883 49.834v-32.89l27.536 16.445z" />
                                <path
                ...
                <div class="col__content">
                    <h3>Design</h3>
                    <p>Several mockups and prototypes based on your requirements are created during this phase. This
                        allows you
                        to review a visual representation of our understanding of your needs early on in the project.
                        We can further solidify your requirements and discover any additional needs or challenges that
                        did not present themselves in the planning phase.</p>
                </div>
            </div>
            <!--Design End -->
            <!--Build Start  -->
            <div class="col col3">
                <div class="col__visual">
                    <svg id="Layer_1" enable-background="new 0 0 512 512" height="" viewBox="0 0 512 512" width=""
                        xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <g>
                                <path
                ...
                <div class="col__content">
                    <h3>Build</h3>
                    <p>In this phase, we begin the process of building your app or website. We place a heavy emphasis
                        on adhering to the technical and design specifications laid out in the planning phase, and
                        perform regular functional tests, which allows us to correct any problems during the build
                        rather than addressing them after project completion.</p>
                </div>
            </div>
            <!--Build End -->
            <!--Test Start  -->
            <div class="col col4">
                <div class="col__visual">
                    <svg height="" viewBox="0 -21 437.67202 437" width="437pt" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="m430.671875.335938h-423.671875c-3.867188 0-7 3.132812-7 7v287.023437c0 3.867187 3.132812 7 7 7h159.71875l-9.082031 55.5625h-29.433594c-17.25.019531-31.230469 14-31.25 31.25 0 3.867187 3.132813 7 7 7h229.765625c3.867188 0 7-3.132813 7-7-.019531-17.25-13.996094-31.230469-31.246094-31.25h-29.4375l-9.085937-55.570313h159.722656c3.867187 0 7-3.132812 7-7v-287c.003906-1.859374-.730469-3.644531-2.042969-4.960937-1.316406-1.316406-3.097656-2.054687-4.957031-2.054687zm-416.671875 14h409.671875v10.664062h-409.671875zm409.671875 24.664062v191.71875h-409.671875v-191.722656zm-98.4375 342.167969h-212.796875c2.769531-6.230469 8.949219-10.246094 15.765625-10.253907h181.265625c6.816406.007813 12.996094 4.023438 15.765625 10.253907zm-59.367187-24.253907h-94.0625l9.101562-55.5625h75.855469zm157.804687-69.5625h-409.671875v-42.636718h409.671875zm-224.097656-89.667968c2.546875.898437 5.386719.257812 7.296875-1.648438l6.117187-6.113281 32.5 32.5c1.3125 1.3125 3.09375 2.050781 4.949219 2.050781 1.859375 0 3.636719-.738281 4.949219-2.050781l14-14c1.316406-1.3125 2.054687-3.09375 2.054687-4.953125 0-1.855469-.738281-3.636719-2.054687-4.949219l-32.5-32.5 6.117187-6.117187c1.910156-1.910156 2.550782-4.75 1.644532-7.292969-.90625-2.546875-3.195313-4.34375-5.882813-4.617187l-40.25-4.109376c-2.09375-.214843-4.175781.523438-5.664063 2.011719-1.488281 1.492188-2.230468 3.570313-2.015624 5.664063l4.117187 40.246094c.277344 2.6875 2.074219 4.976562 4.621094 5.878906zm23.109375-37.253906-.652344.648437c-1.3125 1.3125-2.050781 3.09375-2.050781 4.953125 0 1.855469.738281 3.636719 2.050781 4.949219l32.5 32.5-4.09375 4.09375-32.5-32.5c-1.3125-1.3125-3.09375-2.050781-4.953125-2.050781-1.855469 0-3.636719.738281-4.949219 2.050781l-.652344.652343-1.742187-17.039062zm-179.640625-85.667969c3.558593-.003907 6.546875-2.667969 6.957031-6.203125h12.117188l13.824218 88c-9.421875 2.632812-15.507812 11.746094-14.328125 21.457031 1.179688 9.707031 9.269531 17.101563 19.042969 17.40625h3.832031c-1.84375 4.367187-.511719 9.429687 3.242188 12.328125 3.757812 2.894531 8.992187 2.894531 12.75 0 3.753906-2.898438 5.089843-7.960938 3.242187-12.328125h33.722656c-1.84375 4.367187-.511718 9.425781 3.242188 12.320313 3.757812 2.890624 8.988281 2.890624 12.742188 0 3.753906-2.894532 5.089843-7.953126 3.246093-12.320313h12.089844c3.863281 0 7-3.136719 7-7 0-3.867187-3.136719-7-7-7h-87.644531c-3.03125-.128906-5.457032-2.558594-5.578125-5.589844-.121094-3.027343 2.101562-5.644531 5.113281-6.011719l92.890625-10.296874c.90625 3.398437 4.191406 5.59375 7.675781 5.140624 3.484375-.457031 6.089844-3.429687 6.089844-6.945312-.019531-3.15625-1.253906-6.1875-3.441406-8.460938 2.253906-3.683593 3.445312-7.917968 3.441406-12.234374v-24.800782c2.101562-1.957031 2.789062-5 1.730469-7.671875-1.054688-2.671875-3.636719-4.425781-6.507813-4.417969h-101.300781l-5.40625-34.402343c-.984375-6.433594-6.53125-11.175781-13.039063-11.144531h-13.554687c-7.289063 0-13.199219 5.90625-13.199219 13.199218.015625 3.859375 3.148438 6.980469 7.007813 6.976563zm121.886719 71.625-55.925782 6.203125-19.101562 2.113281-2.304688-14.691406h85.199219c-1.152344 3.480469-4.226563 5.96875-7.867187 6.375zm8.398437-32.269531v11.894531h-87.933594l-1.867187-11.894531zm165.390625 66.257812c34.746094 0 62.910156-28.164062 62.910156-62.90625s-28.164062-62.910156-62.910156-62.910156c-34.742188 0-62.90625 28.167968-62.90625 62.910156.039062 34.726562 28.179688 62.867188 62.90625 62.90625zm0-111.816406c27.011719 0 48.910156 21.898437 48.910156 48.910156s-21.898437 48.90625-48.910156 48.90625-48.90625-21.894531-48.90625-48.90625c.023438-27.003906 21.90625-48.886719 48.90625-48.917969zm-14.761719 65.332031c-2.144531-1.441406-5.035156-1.039063-6.699219.9375l-.800781.960937c-.933593 1.09375-1.363281 2.53125-1.179687 3.957032.1875 1.425781.964844 2.710937 2.148437 3.53125 4.910157 3.238281 10.503907 5.289062 16.34375 6v3.808594c0 2.8125 2.28125 5.09375 5.09375 5.09375 2.816407 0 5.097657-2.28125 5.097657-5.09375v-3.734376c11.574218-1.484374 18.257812-8.488281 18.257812-18.453124 0-10.101563-7.199219-14.101563-18.257812-16.835938v-13.648438c2.160156.675782 4.242187 1.59375 6.195312 2.738282 2.253906 1.347656 5.160156.761718 6.714844-1.351563l.730468-1c.832032-1.125 1.164063-2.546875.914063-3.925781s-1.058594-2.59375-2.234375-3.355469c-3.761719-2.3125-7.953125-3.835937-12.320312-4.480469v-7.199218c0-2.8125-2.28125-5.097656-5.097657-5.097656-2.8125 0-5.09375 2.285156-5.09375 5.097656v6.851562c-10.933593 1.375-18.132812 8.421875-18.132812 18.21875 0 10.402344 7.390625 14.269532 18.136719 17.023438v14.265625c-3.515626-.808594-6.84375-2.269531-9.816407-4.308594zm20-7.332031c3.878907 1.316406 5.449219 2.855468 5.449219 5.710937-.140625 3.0625-2.417969 5.601563-5.449219 6.074219zm-15.519531-20.933594c.144531-2.992188 2.371094-5.46875 5.328125-5.933594v11.6875c-3.789063-1.285156-5.328125-2.917968-5.328125-5.753906zm59.839844 93.851562c0 3.867188-3.136719 7-7 7h-85.117188c-3.867187 0-7-3.132812-7-7 0-3.867187 3.132813-7 7-7h85.117188c3.863281 0 7 3.132813 7 7zm0 0" />
                    </svg>

                </div>
                <div class="col__content">
                    <h3>Test & Train</h3>
                    <p>We perform thorough testing on all sites and apps prior to final launch. We simulate heavy
                        stress to measure performance, and test various browsers, operating systems, and devices with
                        the site or app to be sure that it is responsive and performs well across all platforms. If
                        requested by the client, we also perform training with your staff, so that they will be able
                        to easily make minor adjustments or publish new content once your site or app is live.</p>
                </div>
            </div>
            <!--Test End  -->
            <!--Launch Start  -->
            <div class="col col5">
                <div class="col__visual">
                    <svg viewBox="0 0 512.00201 512" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="m380.144531 238.1875c29.242188-29.242188 29.242188-76.820312 0-106.0625-29.308593-29.308594-76.75-29.316406-106.0625 0-29.242187 29.238281-29.242187 76.820312 0 106.0625 29.308594 29.308594 76.75 29.3125 106.0625 0zm-84.851562-84.851562c17.585937-17.582032 46.050781-17.585938 63.640625 0 17.542968 17.546874 17.542968 46.09375 0 63.640624-17.585938 17.585938-46.050782 17.589844-63.640625 0-17.542969-17.546874-17.542969-46.09375 0-63.640624zm0 0" />
                        <path
                            d="m.691406 492.496094c-1.675781 5.328125-.253906 11.144531 3.6875 15.097656 3.945313 3.953125 9.761719 5.390625 15.089844 3.726562 13.023438-4.066406 128.148438-40.605468 159.15625-71.609374 8.304688-8.308594 15.066406-17.691407 20.054688-27.738282 2.855468.167969 5.414062-.425781 7.703124-1.59375 11.390626-5.8125 23.519532-11.847656 36.335938-18.261718 5.957031 77.636718 5.484375 65.023437 5.503906 73.648437.027344 11.195313 11.84375 18.347656 21.742188 13.363281 3.738281-2.484375 42.542968-16.664062 69.894531-61.007812 15.183594-24.613282 23.109375-52.917969 23.109375-81.847656v-10.308594c22.582031-14.609375 43.597656-30.210938 60.824219-46.84375 74.527343-71.949219 91.355469-160.515625 87.757812-264.195313-.273437-7.875-6.597656-14.199219-14.472656-14.472656-103.652344-3.597656-192.238281 13.21875-264.199219 87.757813-16.304687 16.890624-31.628906 36.714843-45.992187 58.796874h-12.476563c-58.375 0-112.675781 33.363282-139.253906 86.546876l-3.601562 7.164062c-2.339844 4.644531-2.105469 10.164062.617187 14.59375s7.542969 7.136719 12.742187 7.148438c8.511719.023437-4.617187-.578126 75.105469 6.550781-6.289062 12.570312-12.546875 25.136719-18.394531 36.605469-1.308594 2.5625-1.816406 5.371093-1.582031 8.101562-9.949219 4.976562-19.246094 11.691406-27.480469 19.925781-30.996094 30.992188-67.777344 145.855469-71.871094 158.851563zm201.792969-113.777344-69.203125-69.203125c4.398438-8.71875 8.847656-17.652344 14.160156-28.265625l83.308594 83.3125c-10.921875 5.464844-19.4375 9.707031-28.265625 14.15625zm74.21875 62.5-5.050781-63.703125c20.144531-10.300781 40.941406-21.3125 61.152344-33.050781-2.519532 39.632812-23.25 75.171875-56.101563 96.753906zm205.21875-411.140625c.503906 32.765625-1.394531 61.765625-5.960937 87.84375-42.570313-6.015625-75.863282-39.3125-81.878907-81.878906 26.074219-4.566407 55.074219-6.464844 87.839844-5.964844zm-227.460937 78.96875c31.425781-32.550781 66.488281-54.125 110.285156-66.394531 4.222656 26.082031 16.476562 50.152344 35.464844 69.136718 18.988281 18.988282 43.054687 31.246094 69.136718 35.464844-12.269531 43.796875-33.84375 78.863282-66.394531 110.285156-36.320313 35.066407-92.160156 66.234376-144.015625 92.785157l-97.257812-97.261719c26.546874-51.855469 57.714843-107.691406 92.78125-144.015625zm-185.144532 125.160156c21.953125-33.578125 58.460938-54.53125 99.042969-56.433593-12.019531 20.613281-23.285156 41.871093-33.808594 62.449218zm49.984375 103.753907 16.898438 16.898437-31.820313 31.820313c-5.859375 5.855468-5.859375 15.355468 0 21.210937 5.855469 5.859375 15.355469 5.859375 21.210938 0l31.820312-31.820313 16.898438 16.898438c-3.59375 9.253906-9.335938 17.964844-16.898438 25.527344-17.191406 17.195312-77.464844 40.574218-118.703125 54.855468 14.367188-41.152343 37.855469-101.285156 55.066407-118.492187 7.5625-7.5625 16.273437-13.304687 25.527343-16.898437zm0 0" />
                        <path
                            d="m252.605469 259.390625c-5.855469-5.855469-15.355469-5.855469-21.210938 0-5.859375 5.859375-5.859375 15.355469 0 21.214844 5.855469 5.855469 15.355469 5.855469 21.210938 0 5.859375-5.859375 5.859375-15.355469 0-21.214844zm0 0" />
                    </svg>
                </div>
                <div class="col__content">
                    <h3>Launch</h3>
                    <p>The live launch of your site or app can be a stressful period. Even with thorough testing
                        throughout development, unforeseen challenges can arise. That is why Beano Web Design
                        team provides full monitoring and support during the launch period. We stand ready to
                        make sure that your launch is successful, and are ready to quickly address any issues
                        that may arise.</p>
                </div>
            </div>
            <!--Launch End -->
            ...
            <div class="col col6">
                ...
                <div class="col__content">
                    <h3>Support</h3>
                    <p>Once your site launches successfully, you'll still require a technical partner to support ongoing
                        needs. We offer a wide variety of support services for our completed projects, including
                        monitoring and optimisation.</p>
                </div>
            </div>
            <!--Support End  -->
        </div>
    ...
    <!-- Services End -->
    <!-- Our Work Start -->
    <section class="ourWork" id="work">
        <div class="ourWorkHeading">
            <h2>Our Work</h2>
            <span></span>
            <p>At Beano Web Design, we don't like to be constrained by "our style". We prefer much more to keep an
                open mind and listen to your needs. Together we can tailor the best website you need!</p>
        </div>
        <div class="carousel__wrapper">
            <div class="carousel__wrapper-item item-1"> 
                 <img srcset="/css/assets/File_thumb_xxlarge1.jpg 3676w,
                /css/assets/File_thumb_xlarge1.jpg 1920w,
                /css/assets/File_thumb_large1.jpg 1280w,
                /css/assets/File_thumb_medium1.jpg 1024w,
                /css/assets/File_thumb_small1.jpg 640w,
                /css/assets/File_thumb_xsmall1.jpg 320w" sizes="(min-width: 36em) 90vw,
                100vw" src="/css/assets/File_thumb_fallback1.jpg" alt="thumbnail of website">
                <div class="imgOverlay">
                    <span class="name">
                        <span>Natours offers<br> an incredible variety of
                            trips<br>for groups of any size</span>
                    </span>
                </div>
            </div> 
            <div class="carousel__wrapper-item item-2">
                   <img srcset="/css/assets/File_thumb_xxlarge2.jpg 3676w,
                /css/assets/File_thumb_xlarge2.jpg 1920w,
                /css/assets/File_thumb_large2.jpg 1280w,
                /css/assets/File_thumb_medium2.jpg 1024w,
                /css/assets/File_thumb_small2.jpg 640w,
                /css/assets/File_thumb_xsmall2.jpg 320w" sizes="(min-width: 36em) 90vw,
                100vw" src="/css/assets/File_thumb_fallback2.jpg" alt="thumbnail of website">
                <div class="imgOverlay">
                    <span class="name">
                        <span>Omnifood has amazing food plans <br> and delivers your meals<br>at
                            your door</span>
                    </span>
                </div>
            </div>
            <div class="carousel__wrapper-item item-3">
                 <img srcset="/css/assets/File_thumb_xxlarge3.jpg 3676w,
                /css/assets/File_thumb_xlarge3.jpg 1920w,
                /css/assets/File_thumb_large3.jpg 1280w,
                /css/assets/File_thumb_medium3.jpg 1024w,
                /css/assets/File_thumb_small3.jpg 640w,
                /css/assets/File_thumb_xsmall3.jpg 320w" sizes="(min-width: 36em) 90vw,
                100vw" src="/css/assets/File_thumb_fallback3.jpg" alt="thumbnail of website">
                <div class="imgOverlay">
                    <span class="name">
                        <span>Cuisine Restaurant is <br> a food delivery service<br> with incredible
                            deals!
                        </span>
                    </span>
                </div>
            </div>
            <div class="carousel__wrapper-item item-4">
               <img srcset="/css/assets/File_thumb_xxlarge4.jpg 3676w,
                /css/assets/File_thumb_xlarge4.jpg 1920w,
                /css/assets/File_thumb_large4.jpg 1280w,
                /css/assets/File_thumb_medium4.jpg 1024w,
                /css/assets/File_thumb_small4.jpg 640w,
                /css/assets/File_thumb_xsmall4.jpg 320w" 
                sizes="(min-width: 36em) 90vw,
                100vw"
               src="/css/assets/File_thumb_fallback4.jpg" 
               alt="thumbnail of website">
                <div class="imgOverlay">
                    <span class="name">
                        <span>Ayesha is a hair saloon <br> prototype we created <br> for one of our largest
                            clients</span>
                    </span>
                </div>

            </div>
            <div class="carousel__wrapper-item item-5">
                 <img srcset="/css/assets/File_thumb_xxlarge5.jpg 3676w,
                /css/assets/File_thumb_xlarge5.jpg 1920w,
                /css/assets/File_thumb_large5.jpg 1280w,
                /css/assets/File_thumb_medium5.jpg 1024w,
                /css/assets/File_thumb_small5.jpg 640w,
                /css/assets/File_thumb_xsmall5.jpg 320w" 
                sizes="(min-width: 36em) 90vw,
                100vw" src="/css/assets/File_thumb_fallback5.jpg" alt="thumbnail of website">
                <div class="imgOverlay">
                    <span class="name">
                        <span>Trello is a prototype app matching <br> users with multiple
                            holiday
                            destinations</span>
                    </span>
                </div>
            </div>
            <div class="carousel__wrapper-item item-6">
                 <img srcset="/css/assets/File_thumb_xxlarge6.jpg 3676w,
                /css/assets/File_thumb_xlarge6.jpg 1920w,
                /css/assets/File_thumb_large6.jpg 1280w,
                /css/assets/File_thumb_medium6.jpg 1024w,
                /css/assets/File_thumb_small6.jpg 640w,
                /css/assets/File_thumb_xsmall6.jpg 320w" sizes="(min-width: 36em) 90vw,
                100vw" src="/css/assets/File_thumb_fallback6.jpg" alt="thumbnail of website">
                <div class="imgOverlay">
                    <span class="name">
                        <span>Mad about Interiors is a blog app<br>for Interior Designers
                        </span>
                    </span>
                </div>
            </div>
    ...
    <section class="packages" id='packages'>
        <div class="plansHeading">
            <h2>Our Packages</h2>
            <span></span>
            <p>An online presence for your business has never been more essential. We work hard to give you a
                professional web presence by creating appealing, user friendly and totally responsive websites. <br>
                After all, did you know that more than a half of your future clients will see your site on a mobile
                device? </p>
        </div>
        <div class="packages__container">
            ...
            <div class="card">
                <div class="circle">
                    <h3>Starter</h3>
                    <h4>Get your website online in days</h4>
                </div>
                <div class="content">
                    <ul>
                        <li>
                            A stunning handcrafted website
                        </li>
                        <li>
                    ...
                    <a class="btn expand" href="#contact">Get in touch</a>
                </div>
            </div>
            <!-- Plan 1 End -->
            <!-- Plan 2 Start -->
            <div class="card">
                <div class="circle">
                    <h3>Large Brochure Style</h3>
                    <h4>The perfect solution <br> for a powerful start</h4>
                </div>
                <div class="content">
                    <ul>
                        <li>
            ...
            <div class="card">
                <div class="circle">
                    ...
                    <h4>Suitable for business with <br> greater requirements</h4>
                </div>
                <div class="content">
                    <ul>
                        <li>
    ...
    <section class="contact" id='contact'>
        <div class="logo__containter logoContact">
            <a href="#home">
                <svg class="customColor" width="" height="" viewBox="0 0 157 300" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <rect x="1.5" y="1.5" width="154" height="297" stroke="white" stroke-width="12" />
        ...
        <div class="contact__heading">
            ...
            <p>We are here to help and would love to hear about your next project. <br> Drop us a line and we will get
                back
                to you at the speed of light. </p>
        </div>
        <div class="contact__form">
            <form class="form" name="contact" method="POST" data-netlify="true">
                ...
                <input type="email" name="email" id='email' class="form__field"
                    placeholder="Your Email" required>
                <textarea class="form__field" name="message" rows="5" placeholder="Your Message" required></textarea>
                <label for="submit"></label>
                <input type="submit" name="submit" id='submit' class="btn send_btn expand" value="Send">
    ...
    <footer>
        <div class="infoDetail">
            <span>Beano Web Design</span>
            <span>07796 408581</span>
            <span>50 Dean Path</span>
            <span>Edinburgh EH4 3AU</span>
        </div>
        <div class="copyRight">
            <a href="https://beanowebdesign.com">&copy;Credits</a>
        </div>
        <div class="social">
            <div class="socialIcon phone">
                <a href="tel:447796408581">
            ...
            <div class="socialIcon whatsapp">
                <a href="https://api.whatsapp.com/send?phone=447474964865">
            ...
            <div class="socialIcon envelope">
                <a href="mailto:emmanuelfabiani@beanowebdesign.com">
            ...
            <div class="socialIcon twitter">
                <a href="https://twitter.com/CodeLeviosa">
